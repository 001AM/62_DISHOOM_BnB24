    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="grid h-full grid-cols-1 gap-6 px-2 sm:grid-cols-6 md:grid-cols-12">
        ...
        <div className="flex items-center justify-center h-full col-span-1 lg:col-span-4 sm:col-span-4">
          {!next ? (
            <div className="flex flex-col items-center justify-center w-full p-4 mx-auto rounded-md h-42 bg-slate-300">
              <FaLock size={150} />
            ...
            <div className="flex items-center justify-center w-full p-4 mx-auto bg-green-400 rounded-md h-42">
